...
import { exportAllTeachersPDF, exportMasterSchedulePDF } from "@/lib/pdfGenerator";
...
export default function MasterSchedule() {
  ...
  const handlePDFExport = async (options: PDFCustomizationOptions) => {
    try {
      ...
      await exportMasterSchedulePDF(sortedTeachers, slots, teacherNotes, options);
      toast({
        title: "تم التصدير",
